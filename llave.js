const API_URL = `${API_BASE_URL_CLIENTE}/dw_api.php`;
    ...
    (function _setupLoginUI() {
        ...
        /* El FAB usa var(--bg-card) y var(--text-white) que ya cambian con dark-mode */
        ...
        if (banner) {
            ...
            // mask-image hace transparente toda la capa incluidos los hijos
            banner.style.setProperty('-webkit-mask-image', 'none');
            banner.style.setProperty('mask-image', 'none');
            // opacity: 0.9 del .login-banner-bg también lava el overlay
            banner.style.opacity = '1';
            // Resetear position/size del .login-banner-bg (position:absolute, height:60vh)
            ...
            banner.style.left     = '';
            banner.style.zIndex   = '';
            // Quitar blend mode del background
        ...
        if (mainBox) {
            // Buscar y reemplazar el div de copyright existente
        ...
        themeFab.addEventListener('click', () => {
            ...
            // Sincronizar con el toggle del sidebar si existe
            ...
            // Cambiar ícono con pequeño delay para que coincida con la animación
            setTimeout(() => {
